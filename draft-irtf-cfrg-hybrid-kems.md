...
SP 800-227 IPD, and gives good binding properties <!-- todo: link to binding
properties sections --> is generally safe with no caveats on use for
constructing concrete instances using a broad array of components.
