    ...
    K::Error: std::fmt::Debug,
{
    ...
    if K::INPUT_LENGTH > 0 {
        ...
        assert_ne!(output, output3, "Different inputs should produce different outputs");
    }
}
    ...
    P::Error: std::fmt::Debug,
{
    ...
    assert!(P::OUTPUT_LENGTH > P::INPUT_LENGTH, "PRG should expand input");
    ...
    if P::INPUT_LENGTH > 0 {
        ...
        assert_ne!(output, output3, "Different seeds should produce different outputs");
    }
}
    ...
    G::Error: std::fmt::Debug,
{
    ...
    assert_eq!(shared_secret.len(), G::SHARED_SECRET_LENGTH, "Shared secret length mismatch");
}
    ...
    G::Error: std::fmt::Debug,
{
    ...
    assert_eq!(secret_ab, secret_ba, "Diffie-Hellman shared secrets should be equal");
